...
# Training script for Benchmark 2: PCN Hold-out Class
# Trains AdaPoinTr while holding out one PCN class
#
...
#
# Usage:
#   bash scripts/train_pcn_holdout.sh <holdout_class> [gpu_id]
#
# Example:
#   bash scripts/train_pcn_holdout.sh 02691156 0

if [ $# -lt 1 ]; then
    echo "Usage: bash scripts/train_pcn_holdout.sh <holdout_class> [gpu_id]"
    echo ""
    ...
    echo ""
    echo "Example:"
    echo "  bash scripts/train_pcn_holdout.sh 02691156 0"
    exit 1
fi
...
echo "=========================================="
echo "PCN Hold-out Class Training"
echo "=========================================="
...
echo ""
echo "Training complete! Check experiments/AdaPoinTr_PCN_holdout_${CATEGORY_NAME}/ for results."
