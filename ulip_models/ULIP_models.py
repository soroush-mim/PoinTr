...
from ulip_models.pointnet2.pointnet2 import Pointnet2_Ssg
from data.dataset_3d import  *
import torch

from ulip_models import losses
...
def ULIP_PN_MLP(args):
    ...
    # =====================================================================
    # import the 3D backbone and specify the output point cloud feature dimension
    from ulip_models.pointmlp.pointMLP import pointMLP
...
def ULIP2_PointBERT_Colored(args):
    ...
    # Specify custom cache directory for pretrained models
    ...
    # =====================================================================
    # import the 3D backbone and specify the output point cloud feature dimension
    from ulip_models.pointbert.point_encoder import PointTransformer, PointTransformer_Colored
    config_addr = './ulip_models/pointbert/ULIP_2_PointBERT_10k_colored_pointclouds.yaml'
    config = cfg_from_yaml_file(config_addr)
...
def ULIP_PN_NEXT(args):
    ...
    # =====================================================================
    # import the 3D backbone and specify the output point cloud feature dimension
    from ulip_models.pointnext.pointnext import PointNEXT
...
def ULIP_CUSTOMIZED(args):
    ...
    from ulip_models.customized_backbone.customized_backbone import CUSTOMIZED_BACKBONE
